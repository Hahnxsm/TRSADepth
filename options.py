...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--split",
                                 ...
                                 choices=["eigen_zhou", "eigen_full", "odom", "benchmark",'eigen','midair','china','germany','china_germany','uav_ula'],
                                 default="eigen_zhou")
        ...
        self.parser.add_argument("--dataset",
                                 ...
                                 default="kitti",
                                 choices=["kitti", "kitti_odom", "kitti_depth", "kitti_test",'uav_ula','uavid'])
        ...
        self.parser.add_argument("--pose_model_type",
                                 ...
                                 choices=["posecnn", "separate_resnet", "shared","resnet"])
        ...
        self.parser.add_argument("--eval_split",
                                 ...
                                 default="eigen",
                                 choices=[
                                    "eigen", "eigen_benchmark", "benchmark", "odom_9", "odom_10",'china','germany','china_germany','uav_ula','henu','ca'],
