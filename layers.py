...
class SEModule(nn.Module):
    def __init__(self,high_feature_channel,low_feature_channels,output_channel=None):
        ...
        out_channel = output_channel if output_channel is not None else high_feature_channel
        reduction = 16
        channel = in_channel
        ...
        self.conv_se = nn.Conv2d(in_channel, out_channel, kernel_size=1,stride=1)
...
class fSEModule(nn.Module):
    def __init__(self, high_feature_channel, low_feature_channels, output_channel=None):
        ...
        channel = in_channel
        reduction = 16
        self.lka = AttentionModule(channel)
